...
secciones críticas: la \textbf{base del fuste} (máximo momento flector y
...
% -----------------------------------------------------------
\subsection{Acciones sobre el fuste}
...
altura del fuste (sin la zapata), se puede comprobar en el anexo de cálculos manuales. 
El empuje del agua actúa desde el N.F.\ ($-2{,}50$~m) hasta la base del 
fuste ($h_w = 7{,}30 - 2{,}50 = 4{,}80$~m).

\begin{table}[H]
  \centering
  \caption{Componentes del empuje horizontal sobre el fuste (por ml)}
...
Altura de aplicación de la resultante sobre la base del fuste:
\[
...
\paragraph{Elección de barras — fuste:}
...
El cortante de cálculo en la base del fuste es:
\[
...
\begin{resultadobox}[Armadura de cortante fuste]
  \[
...
empotrada en la cara del fuste. La presión en la sección de empotramiento
