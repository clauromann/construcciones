...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.78\textwidth]{figures/muro/imagen_planta}
  \caption{Planta de la zona de actuación}
  \label{fig:imagen_planta}
\end{figure}

\section{Normativa de aplicación}

El proyecto se desarrolla conforme a las siguientes normas y disposiciones de aplicación:

\begin{itemize}
  \item \textbf{Código Estructural} (Real Decreto 470/2021): dimensionamiento de
        estructuras de hormigón armado, clases de exposición y armaduras mínimas.
  \item \textbf{EHE-08} (Instrucción de Hormigón Estructural): criterios de
        durabilidad, agresividad química por sulfatos (Tabla~8.2.3.b) y
        recubrimientos nominales.
  \item \textbf{CTE DB-SE-C} (Seguridad Estructural — Cimientos): condiciones
        geotécnicas de la cimentación superficial y profunda.
  \item \textbf{Eurocódigo 7} (UNE-EN 1997-1): diseño geotécnico y
        verificación de estados límite en obras de contención.
  \item \textbf{Real Decreto 1627/1997}: disposiciones mínimas de seguridad
        y salud en obras de construcción.
  \item \textbf{Normativa medioambiental autonómica}: protección del dominio
        público hidráulico y del suelo en zona especialmente protegida
        (condicionantes recogidos en la sección~\ref{subsec:condicionantes}).
\end{itemize}
