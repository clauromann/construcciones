...
% --- Evitar que LaTeX estire espacios para igualar altura de páginas ---
\raggedbottom

% --- Profundidad del índice (incluye hasta \subsubsection) ---
...
% --- Inclusión de PDFs externos (cálculos manuales escaneados) ---
\usepackage{pdfpages}
